...
const uint8_t RLP_DATA_IMM_LEN_COUNT = RLP_LIST_IMM_LEN_START - RLP_DATA_IMM_LEN_START - RLP_MAX_LENGTH_BYTES; // 56
const uint8_t RLP_DATA_IND_LEN_ZERO = RLP_DATA_IMM_LEN_START + RLP_DATA_IMM_LEN_COUNT - 1; // 183
const uint8_t RLP_LIST_IMM_LEN_COUNT = 256 - RLP_LIST_IMM_LEN_START - RLP_MAX_LENGTH_BYTES; // 56
const uint8_t RLP_LIST_IND_LEN_ZERO = RLP_LIST_IMM_LEN_START + RLP_LIST_IMM_LEN_COUNT - 1; //247
